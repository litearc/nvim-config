...
o.set_highlights = function()
  ...
  -- lsp
  hi('LspDiagnosticsVirtualTextHint'      , 'b3' , 'none')
  hi('LspDiagnosticsVirtualTextError'     , 'b3' , 'none')
  hi('LspDiagnosticsVirtualTextWarning'   , 'b3' , 'none')
  hi('LspDiagnosticsDefaultHint'          , 'b5' , 'none')
  hi('LspDiagnosticsFloatingHint'         , 'b5' , 'none')
  hi('LspDiagnosticsDefaultError'         , 'b5' , 'none')
  hi('LspDiagnosticsFloatingError'        , 'b5' , 'none')
  hi('LspDiagnosticsDefaultWarning'       , 'b5' , 'none')
  hi('LspDiagnosticsFloatingWarning'      , 'b5' , 'none')
  hi('LspDiagnosticsDefaultInformation'   , 'b5' , 'none')
  hi('LspDiagnosticsFloatingInformation'  , 'b5' , 'none')
  hi('LspDiagnosticsUnderlineError'       , 'b8' , 'none')
  hi('LspDiagnosticsUnderlineWarning'     , 'b8' , 'none')
  hi('LspDiagnosticsUnderlineInformation' , 'b8' , 'none')
  hi('LspDiagnosticsUnderlineHint'        , 'b8' , 'none')
  hi('LspDiagnosticsSignHint'             , 'bb' , 'none')
  hi('LspDiagnosticsSignError'            , 'b8' , 'none')
  hi('LspDiagnosticsSignWarning'          , 'ba' , 'none')
  hi('LspDiagnosticsSignInformation'      , 'bd' , 'none')
